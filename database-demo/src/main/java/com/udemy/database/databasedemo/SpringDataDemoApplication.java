...
import com.udemy.database.databasedemo.springdata.PersonSpringDataRepository;
...
public class SpringDataDemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		logger.info("Inserting User: 10004. Inserted value: {}", 
				personDao.save(new Person("lenin", "Vizag", new Date())));
		
		logger.info("Update User: 10003. Updated value: {}", 
				personDao.save(new Person(10003, "pavani", "Vizag", new Date())));
	}
